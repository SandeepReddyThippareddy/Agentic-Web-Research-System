...
class Workflow:
    ...
    def _research_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        if not extracted_tools:
            print("WARNING: No extracted tools found, falling back to direct search")
    ...
    def _analyze_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        if not state.companies:
            return {"analysis": "No companies found to analyze. Please try a different search query."}
        ...
        try:
            ...
            return {"analysis": "Error generating recommendations. Please try again."}
